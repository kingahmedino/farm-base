...
//    testImplementation("io.mockk:mockk:mockk-common:1.13.7")


//    androidTestImplementation("androidx.test.ext:junit:1.1.5")
//    androidTestImplementation("androidx.test.espresso:espresso-core:3.5.1")
    testImplementation("org.mockito:mockito-core:5.5.0") // For mocking the Activity
    androidTestImplementation("org.mockito:mockito-android:5.5.0") // For mocking on Android
